...
import CardApi from './Project2Api';
...
const ProjectsCard = () => {
    return (
        <div>
            ...
            <NavLink exact className="bg-info" to="/programming" style={{textDecoration:"none"}}><Button className="text-light">1</Button></NavLink>
            <NavLink exact className="bg-primary" to="/programming2" style={{textDecoration:"none"}}><Button className="text-light">2</Button></NavLink>
